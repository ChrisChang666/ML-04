...
def gen_rnet_data(data_dir, anno_file, pnet_model_file, prefix_path='', use_cuda=True, vis=False):
    ...
    mtcnn_detector = MtcnnDetector(p_model_path=pnet_model_file, # pnet_model_file自行设置
                                   r_model_path=None,
                                   o_model_path=None,
                                   min_face_size=12,
                                   use_cuda=True)
...
def parse_args():
    ...
    parser.add_argument('--pmodel_file', dest='pnet_model_file', help='PNet model file path',
                        default='../results/pnet/log_bs512_lr0.010_072402/check_point/model_050.pth', type=str) # 根据pth保存位置自行修改
    ...
    parser.add_argument('--prefix_path', dest='prefix_path', help='annotation file image prefix root path',
                        default='../dataset/WiderFace/WIDER_train/images', type=str) # 根据自己电脑的路径修改
